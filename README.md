...
```python
from frikanalen_django_api_client.models import MyDataModel
from frikanalen_django_api_client.api.my_tag import get_my_data_model
...
1. Any endpoint which did not have a tag will be in `frikanalen_django_api_client.api.default`
