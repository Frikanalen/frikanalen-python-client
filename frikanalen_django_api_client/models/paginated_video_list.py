...
T = TypeVar("T", bound="PaginatedVideoList")
...
class PaginatedVideoList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Video.from_dict(results_item_data)
        ...
        paginated_video_list.additional_properties = d
        return paginated_video_list
