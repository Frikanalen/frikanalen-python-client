...
T = TypeVar("T", bound="PaginatedScheduleitemReadList")


@_attrs_define
class PaginatedScheduleitemReadList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['ScheduleitemRead']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ScheduleitemRead.from_dict(results_item_data)
        ...
        paginated_scheduleitem_read_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_scheduleitem_read_list.additional_properties = d
        return paginated_scheduleitem_read_list
