...
T = TypeVar("T", bound="PaginatedAsRunList")


@_attrs_define
class PaginatedAsRunList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = AsRun.from_dict(results_item_data)
        ...
        paginated_as_run_list.additional_properties = d
        return paginated_as_run_list
