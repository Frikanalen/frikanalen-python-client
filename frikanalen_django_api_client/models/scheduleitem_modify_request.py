...
T = TypeVar("T", bound="ScheduleitemModifyRequest")


@_attrs_define
class ScheduleitemModifyRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scheduleitem_modify_request = cls(
            starttime=starttime,
            duration=duration,
            video=video,
        ...
        scheduleitem_modify_request.additional_properties = d
        return scheduleitem_modify_request
